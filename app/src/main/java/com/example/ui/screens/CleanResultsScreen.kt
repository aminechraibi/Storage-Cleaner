...
@Composable
fun CleanResultsScreen(
    viewModel: MainViewModel,
    modifier: Modifier = Modifier
) {
    val title by viewModel.resultsTitle.collectAsStateWithLifecycle()
    val items by viewModel.resultsList.collectAsStateWithLifecycle()
    ...
    val isAllSelected = items.isNotEmpty() && selectedIds.size == items.size
            ...
            TopAppBar(
                title = {
                    Column {
                        ...
                        Text(
                            text = "${items.size} items (${StorageUtils.formatBytes(items.sumOf { it.size })})",
                ...
                actions = {
                    TextButton(
                        onClick = {
                            if (isAllSelected) viewModel.deselectAll() else viewModel.selectAll(items)
                        },
                ...
                Card(
                    ...
                    Row(
                        ...
                        Column {
                            ...
                            Text(
                                text = StorageUtils.formatBytes(selectedBytes),
